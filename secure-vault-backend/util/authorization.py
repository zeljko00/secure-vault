...
class CanShareSecret(HasPermission):
    required_endpoint_permissions = {'POST': ['share_secret'], 'GET': ['view_shared_instances']}
...
class CanManageSharedSecret(HasPermission):
    required_endpoint_permissions = {'DELETE': ['delete_shared_secret'], 'PUT': ['update_shared_secret'], 'GET': ['view_shared_secret']}
